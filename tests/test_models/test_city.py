#!/usr/bin/python3
"""Script to perform unit testing for the City class"""
...
class TestCityDocs(unittest.TestCase):
    """Test cases to check the documentation and style compliance of the City class"""

    @classmethod
    def setUpClass(cls):
        """
        Set up for the doc tests;
        Retrieve all functions of the City class to test for presence of docstrings
        """
    ...
    def test_city_module_docstring(self):
        """Test for the presence of a module docstring in city.py"""
    ...
    def test_city_func_docstrings(self):
        """Test for the presence of docstrings in all functions of the City class"""
...
class TestCity(unittest.TestCase):
    """Test to verify the functionality of the City class, inherited from BaseModel"""

    def test_is_subclass(self):
        """Test if the instance of City is a subclass of BaseModel"""
        city = City()
    ...
    def test_name_attr(self):
        """Test the presence of 'name' attribute in City instances"""
        city = City()
    ...
    def test_state_id_attr(self):
        """Test the presence of 'state_id' attribute in City instances"""
        city = City()
    ...
    def test_to_dict_creates_dict(self):
        """Test the to_dict method of a City instance, ensuring it returns a dictionary"""
        c = City()
        new_d = c.to_dict()
    ...
    def test_to_dict_values(self):
        """
        Test that the dictionary returned by to_dict contains correct time format
        and class name for the City instance
        """
    ...
    def test_str(self):
        """Test the __str__ method of the City class, should return a specific format string"""
        city = City()
